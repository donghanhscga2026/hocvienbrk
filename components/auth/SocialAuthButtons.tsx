...
export function SocialAuthButtons({ callbackUrl = "/complete-profile", isLoading: externalLoading, onLoading, buttonText = "Đăng nhập bằng Google" }: SocialAuthButtonsProps) {
