...
async function seedBrkProfile() {
  ...
  const profile = await prisma.siteProfile.create({
    data: {
      ...
      messageDetail: 'MFC mang đến những tri thức thực chiến giúp bạn phát triển bản thân và xây dựng sự nghiệp.',
      messageImage: null,
      showCommunity: true,
      showAllCourses: true,
      communityTitle: 'Cộng đồng MFC',
      coursesTitle: 'Khóa học nổi bật',
      allCoursesTitle: 'Tất cả khóa học',
      footerText: '© 2026 Dòng chảy Phước Báu. Mọi quyền được bảo lưu.',
      metaTitle: 'MFC - Dòng chảy Phước Báu',
