          ...
          <div className="bg-blue-600 text-white px-6 py-4 rounded-2xl shadow-xl flex items-start gap-4 max-w-md">
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-2">
                <Link href="/login?redirect=/admin/youtube-tools/fetch-links" className="bg-white text-blue-600 px-3 py-1 rounded-lg text-xs font-bold hover:bg-blue-50">Đăng nhập</Link>
                <Link href="/register?redirect=/admin/youtube-tools/fetch-links" className="bg-blue-500 text-white px-3 py-1 rounded-lg text-xs font-bold hover:bg-blue-400">Đăng ký</Link>
              </div>
            </div>
          </div>
        </div>
