...
- ❌ **CẤM**: `ĐÃ HOÀN THÀNH CẬP NHẬT`, `HỌC VIỆN BRK`, `CỘNG ĐỒNG MFC`, `MÃ SỐ`...
- ✅ **ĐÚNG**: `Đã hoàn thành cập nhật`, `Học viện BRK`, `Cộng đồng MFC`, `Mã số`...
- **Ngoại lệ** (được phép ALL-CAPS):
  - Từ/chuỗi không dấu hoặc kỹ thuật: `BRKD`, `BRKP`, `MFC`, `ID`, `API`, `OTP`, `HTML`, `BRK01`...
