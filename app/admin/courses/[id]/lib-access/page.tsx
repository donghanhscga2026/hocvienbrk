...
export default function LibAccessPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 pb-32">
            <Link href={`/admin/courses/${id}`} className="inline-flex items-center gap-2 text-xs font-black text-gray-400 uppercase hover:text-purple-600 transition-colors">
                <ArrowLeft className="w-4 h-4" /> Quay lại Course
            </Link>
