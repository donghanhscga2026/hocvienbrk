...
import { Plus, Eye, Edit, Trash2, ToggleLeft, ToggleRight, ArrowLeft } from 'lucide-react'
                        ...
                        <tbody className="divide-y">
                            {landings.map((landing) => (
                                <tr key={landing.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-4 py-3 text-center">
                                        <span className="font-medium">{landing._count.clicks}</span>
                                    </td>
                                    <td className="px-4 py-3 text-center">
                                        <span className="font-medium">{landing._count.conversions}</span>
                                    </td>
                                    <td className="px-4 py-3 text-center">
                                        {landing.isActive ? (
                                    ...
                                    <td className="px-4 py-3 text-right">
                                        <div className="flex items-center justify-end gap-2">
                                            ...
                                            <Link
                                                href={`/admin/landings/${landing.id}/edit`}
