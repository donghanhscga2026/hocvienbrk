...
function YouTubeToolsContent() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-32">
      <Link href="/tools" className="inline-flex items-center gap-2 text-xs font-black text-gray-400 uppercase hover:text-red-600 transition-colors">
        <ArrowLeft className="w-4 h-4" /> CÔNG CỤ
      </Link>
...
function YouTubeToolsWithSuspense() {
  return (
    <Suspense fallback={
      <div className="flex flex-col items-center justify-center min-h-[400px] text-gray-400">
        <Loader2 className="w-8 h-8 animate-spin text-red-500 mb-2" />
...
export default function YouTubeToolsPage() {
  return <YouTubeToolsWithSuspense />
}
